...
class FunctionalTest {
    ...
    @Test
    fun testEmptyBank() {
        assertEquals(N, bank.accountsCount)
        assertEquals(0, bank.totalAmount)
        for (i in 0 until N) assertEquals(0, bank.amount(i))
    }
    ...
    fun testDeposit() {
        ...
        assertEquals(amount, bank.amount(1))
    ...
    fun testWithdraw() {
        ...
        assertEquals(depositAmount, bank.amount(1))
        ...
        assertEquals(depositAmount - withdrawAmount, bank.amount(1))
    ...
    fun testTotalAmount() {
        ...
        assertEquals(deposit2, bank.amount(2))
    ...
    fun testTransfer() {
        ...
        assertEquals(depositAmount - transferAmount, bank.amount(1))
        assertEquals(transferAmount, bank.amount(2))
        assertEquals(depositAmount, bank.totalAmount)
    }
    ...
    fun testConsolidate() {
        ...
        assertEquals(depositAmount1, bank.amount(1))
        ...
        assertEquals(depositAmount2, bank.amount(2))
        ...
        assertEquals(depositAmount3, bank.amount(3))
        assertEquals(depositAmount1 + depositAmount2 + depositResult3, bank.totalAmount)
        bank.consolidate(listOf(1, 2), 4)
        assertEquals(0L, bank.amount(1))
        assertEquals(0L, bank.amount(2))
        assertEquals(depositAmount1 + depositAmount2, bank.amount(4))
        assertEquals(depositAmount1 + depositAmount2 + depositResult3, bank.totalAmount)
        bank.consolidate(listOf(3), 4)
        assertEquals(0L, bank.amount(3))
        assertEquals(depositAmount1 + depositAmount2 + depositResult3, bank.amount(4))
        assertEquals(depositAmount1 + depositAmount2 + depositResult3, bank.totalAmount)
    }
    ...
    fun testModelEquivalence() {
        ...
        val rnd = Random(1)
        repeat(100_000) {
            val operation = Operation.entries.random(rnd)
