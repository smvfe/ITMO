...
4. In the class `IntIntHashMap.Core`, add a new `next: AtomicReference<Core>` field, which references the next version of the table.
...
7. **Write your first and last name in the header of the file after the `@author` tag.**
