...
public class UserRepositoryImpl extends BasicRepositoryImpl<User> implements UserRepository {
    ...
    private static final String USER_INSERT = "INSERT INTO `User` (`login`, `passwordSha`, `creationTime`, `email`) VALUES (?, ?, NOW(), ?)";


    @Override
    public void save(User user, String passwordSha) {
        Object[] params = {user.getLogin(), passwordSha, user.getEmail()};
        saveEntity(USER_INSERT, params, user);
