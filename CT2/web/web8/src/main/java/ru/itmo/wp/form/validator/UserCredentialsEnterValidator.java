...
public class UserCredentialsEnterValidator implements Validator {
    ...
    public void validate(Object target, Errors errors) {
        if (!errors.hasErrors()) {
            ...
            else if (userService.findByLoginAndPassword(enterForm.getLogin(), enterForm.getPassword()).getDisable()) {
                errors.rejectValue("disable", "user.disable", "User is disabled");
            }
        }
    }
}
